...
const EditarOportunidadePage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            delete data.contaNome;
            delete data.contatoNome;
            ...
            await OportunidadeService.atualizar(id, data);
            toast.current?.show({
                severity: 'success',
                summary: 'Sucesso',
                detail: 'Oportunidade atualizada com sucesso!',
                life: 3000
            });
            setTimeout(() => router.push(`/crm/oportunidades/${id}`), 1000);
        } catch (error: any) {
            toast.current?.show({
                severity: 'error',
                summary: 'Erro',
                detail: error?.response?.data?.message || 'Erro ao atualizar oportunidade',
                life: 5000
            });
        } finally {
            setSaving(false);
